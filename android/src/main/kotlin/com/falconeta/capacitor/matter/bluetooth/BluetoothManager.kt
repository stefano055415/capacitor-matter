package com.falconeta.capacitor.matter.chip.bluetooth
...
class BluetoothManager : BleCallback {
   ...
   */
  @SuppressLint("MissingPermission")
  suspend fun connect(context: Context, device: BluetoothDevice, chipClient: ChipClient): BluetoothGatt? {
    return suspendCancellableCoroutine { continuation ->
      val bluetoothGattCallback = getBluetoothGattCallback(context, continuation, chipClient)
